    ...
    <?php $this->load->view('admin/includes/_messages.php') ?>
 		<div class="card">
 			<div class="card-header">
 				<div class="d-inline-block">
 					<h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Multiple Files Upload Example</h3>
 				</div>
 			</div>
 		</div> 
 		...
 		<div class="card">
 			<div class="card-body table-responsive">
 				<!-- Multiple Uploads -->
 				<p class="lead">Multiple Files Uploader </p>
 				<small>The files in this example don't upload to server from demo account.</small>
 				<!-- Upload  -->

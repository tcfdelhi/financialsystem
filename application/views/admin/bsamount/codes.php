        ...
        <div class="card">
            ...
            <div class="body">
                <div class="row clearfix">
                    ...
                    <?php echo form_open(base_url('admin/bsamount/list/'), 'class="form-horizontal"');  ?>
                    ...
                    <div class="row clearfix col-md-12">
                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                            <input type="submit" name="submit" value="<?= languagedata($this->session->userdata('session_language'), "View BS Amount"); ?>" class="btn btn-primary m-t-15 waves-effect">
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>

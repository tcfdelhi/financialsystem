	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			<div class="header">
				...
				<a href="<?= base_url('admin/clients/add'); ?>" class="btn bg-indigo waves-effect pull-right"><i class="material-icons">person_add</i> ADD NEW ADMIN</a>
			</div>
			<div class="body">
...
<script type="text/javascript">
	...
	var table = $('#na_datatable').DataTable({
		"processing": true,
		"serverSide": true,
		"ajax": "<?= base_url('admin/clients/get_admins') ?>",
		"order": [
			[5, 'desc']
		],
		"columnDefs": [{

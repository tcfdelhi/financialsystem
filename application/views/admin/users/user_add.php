...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                <?= languagedata($this->session->userdata('session_language'), "Add New Client"); ?>
                </h2>
                <a href="<?= base_url('admin/users/'); ?>" class="btn bg-indigo waves-effect pull-right"><?= languagedata($this->session->userdata('session_language'), "Clients List"); ?></a>
            </div>
            <div class="body">
                <div class="row clearfix">
                    <div class="col-md-12">

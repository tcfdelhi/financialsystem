        ...
        <div class="card">
            ...
            <div class="body">
                <div class="row clearfix">
                    ...
                    <?php echo form_open(base_url('admin/settings/add_currency/'.$id), 'class="form-horizontal"');  ?>
                    ...
                    <div class="row clearfix col-md-6">
                        <div class="col-lg-4 col-md-2 col-sm-4 col-xs-5 form-control-label">
                            <label for="name">Currency Short Form</label>
                        </div>
                        <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="short_name" class="form-control" value="<?= (isset($currency['short_name'])?$currency['short_name']:set_value('short_name')) ?>" >
                                </div>
                            </div>
                        </div>
                    </div>

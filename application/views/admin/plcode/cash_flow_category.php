                        ...
                        <tbody>
                            ...
                            foreach ($cash_flow_categories as $row) : ?>
                                <tr>
                                    ...
                                    <td><?= $row['name']; ?></td>
                                    <td>
                                        <a title="Edit" class="update btn btn-sm btn-primary" href="<?= base_url('admin/plcode/add_cash_flow/' . $row['id']) ?>"><i class="material-icons">edit</i></a>
                                        <a title="Delete" class="delete btn btn-sm btn-danger" data-href="<?= base_url('admin/plcode/delete_cash_flow/' . $row['id']); ?>" data-toggle="modal" data-target="#confirm-delete"><i class="material-icons">delete</i>
                                        </a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
...
<script>
    ...
    $("#pl_cash_flow_category").addClass('active');

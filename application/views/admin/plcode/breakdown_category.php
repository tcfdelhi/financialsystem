            ...
            <div class="body">
                <div class="table-responsive">
                    <table id="na_datatable" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <tbody>
                            <?php $count = 0;
                            foreach ($breakdown_cat as $row) : ?>
                                <tr>
                                    <td><?= ++$count; ?></td>
                                    <td><?= $row['name']; ?></td>
                                    <td>
                                        <a title="Edit" class="update btn btn-sm btn-primary" href="<?= base_url('admin/plcode/add_breakdown/' . $row['id']) ?>"><i class="material-icons">edit</i></a>
                                        <a title="Delete" class="delete btn btn-sm btn-danger" data-href="<?= base_url('admin/plcode/delete_breakdown/' . $row['id']); ?>" data-toggle="modal" data-target="#confirm-delete"><i class="material-icons">delete</i>
                                        </a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
